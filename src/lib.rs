...
pub mod renderer {
    pub use cabat_renderer::{
        ...
        crates, plugins, render_tools,
        renderers::{text, texture3d},
        shared, texture, ClearColor, Device, FullRendererPlugin, Queue, RenderEncoder, RenderPass,
        RenderPassDesc, Surface, SurfaceConfig, Vertex,
    };
}
